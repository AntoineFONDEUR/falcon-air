...
use crate::preprocessed::xor_8_8_8::{N_BITS_IN_LIMB, N_INPUT_COLUMNS};
...
impl Claim {
    ...
    pub fn generate_trace<'a>(
        requested_xor_8_8_8: impl ParallelIterator<Item = &'a [[PackedM31; 4]]>,
    ) -> (
        Self,
        ...
        SimdBackend: BackendForChannel<Blake2sMerkleChannel>,
    {
        ...
        requested_xor_8_8_8.for_each(|entries| {
        ...
        // Build first 4 columns to match preprocessed xor_8_8_8
        ...
        let xor_8_8_8: Vec<[PackedM31; 5]> = a_packed
            .into_par_iter()
        ...
        (
            ...
            InteractionClaimData {
                lookup_data: LookupData { xor_8_8_8 },
            },
        )
    }
}
